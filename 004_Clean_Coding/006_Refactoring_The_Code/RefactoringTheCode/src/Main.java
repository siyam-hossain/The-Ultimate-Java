...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
            1. We refactor by selecting the portion we want
            2. Then right click and choose refactor
            3. then method if we want to create
         */
    ...
    public static void printPaymentSchedule(int years, int principal, double annualInterest) {
        System.out.println();
